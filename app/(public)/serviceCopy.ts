...
const translatedServices: Record<Exclude<PublicLocale, "de">, Record<Service["id"], ServiceText>> = {
  en: {
    ...
    keramikversiegelung: {
      ...
      includes: ["Thorough paint preparation", "Surface degreasing", "Ceramic coating application", "Hydrophobic protection", "Gloss and finish inspection"],
  ...
  fr: {
    ...
    keramikversiegelung: {
      ...
      includes: ["Préparation complète de la peinture", "Dégraissage de la surface", "Application de la protection céramique", "Protection hydrophobe", "Contrôle de la brillance et de la finition"],
  ...
  it: {
    ...
    keramikversiegelung: {
      ...
      includes: ["Preparazione accurata della vernice", "Sgrassaggio della superficie", "Applicazione del rivestimento ceramico", "Protezione idrofobica", "Controllo di brillantezza e finitura"],
